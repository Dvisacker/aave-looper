...
```*/
    ...
    ///Container for all the [`IAavePriceOracle`](self) function calls.
    pub enum IAavePriceOracleCalls {
        getAssetPrice(getAssetPriceCall),
    }
    #[automatically_derived]
    impl IAavePriceOracleCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[179u8, 89u8, 111u8, 7u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IAavePriceOracleCalls {
        const NAME: &'static str = "IAavePriceOracleCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IAavePriceOracleCalls>] = &[
                {
                    fn getAssetPrice(
                        data: &[u8],
                        validate: bool,
                        ...
                        <getAssetPriceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IAavePriceOracleCalls::getAssetPrice)
                    }
                    getAssetPrice
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IAavePriceOracle`](self) contract instance.

See the [wrapper's documentation](`IAavePriceOracleInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IAavePriceOracleInstance<T, P, N> {
        IAavePriceOracleInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IAavePriceOracleInstance<T, P, N>>,
    > {
        IAavePriceOracleInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IAavePriceOracleInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IAavePriceOracle`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IAavePriceOracle`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IAavePriceOracleInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IAavePriceOracleInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IAavePriceOracleInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IAavePriceOracleInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IAavePriceOracleInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IAavePriceOracleInstance<T, P, N> {
            IAavePriceOracleInstance {
